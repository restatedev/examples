...
export default object({
  ...
  handlers: {
    ...
    getAssignedDelivery: async (ctx: ObjectContext) => ctx.get<DeliveryRequest>(ASSIGNED_DELIVERY),

    // Gets called by the delivery manager when this driver was assigned to do the delivery.
    assignDeliveryJob: async (ctx: ObjectContext, deliveryRequest: DeliveryRequest) => {
...
async function checkIfDriverInExpectedState(

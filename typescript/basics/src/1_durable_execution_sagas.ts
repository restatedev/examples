            ...
            add: async (ctx: restate.Context, req: SubscriptionRequest) => {
                ...
                try {
                    ...
                    for (const subscription of subscriptions) {
                        ...
                        const result = await ctx.run(() => createSubscription(userId, subscription));
...
/*
Invoke this function and see how compensations get triggered for a percentage of the requests.

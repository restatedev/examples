  ...
  const setNewShoppingCartId = () => {
    ...
    (async () => {
      ...
      const {
        ...
        emailAddress,
        purchaseHistory
      } = await grpc('UserProfileService', 'GetUserProfile', { user_id: user!.user_id });
      ...
      await grpc('ShoppingCartService', 'CreateCart', {shopping_cart_id: newShoppingCartId, user_id: userId});

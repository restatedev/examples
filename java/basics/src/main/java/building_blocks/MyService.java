...
import virtual_objects.GreeterObject;
...
public class MyService {
    ...
    public void run() throws Exception {
        ...
        String result = Restate.virtualObject(GreeterObject.class, "my-obj-key").greet("hello");
        ...
        Restate.virtualObjectHandle(GreeterObject.class, "my-obj-key").send(GreeterObject::greet, "hello");
        ...
        var awakeable = Restate.awakeable(String.class);
        // Wait on the promise
        ...
        Restate.awakeableHandle(awakeable.id()).resolve(String.class, "hello");
        ...
        Restate.virtualObjectHandle(GreeterObject.class, "my-obj-key").send(GreeterObject::ungreet, Duration.ofDays(1));
        ...
        Restate.run("charge-bank-account", () -> chargeBankAccount(paymentDeduplicationID, 100));
    }

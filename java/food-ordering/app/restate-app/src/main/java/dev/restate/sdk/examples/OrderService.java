...
public class OrderService extends OrderServiceRestate.OrderServiceRestateImplBase {
    ...
    @Override
    public void handleEvent(RestateContext ctx, OrderProto.KafkaOrderEvent event) throws TerminalException {
        ...
        try {
            ...
            boolean paid = ctx.sideEffect(CoreSerdes.BOOLEAN, () ->
                    paymentClnt.charge(order.orderId, token, order.totalCost));

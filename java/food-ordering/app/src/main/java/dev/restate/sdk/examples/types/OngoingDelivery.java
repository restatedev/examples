...
public class OngoingDelivery {
    ...
    public OngoingDelivery(String orderId, String callbackId, String restaurantId, Location restaurantLocation, Location customerLocation, boolean orderPickedUp) {
